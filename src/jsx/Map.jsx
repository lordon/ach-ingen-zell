...
export class Map extends React.Component {
  render() {
    ...
    this.props.data.forEach((x)=>{
      ...
      placenames[x.id] = `${percentages[x.id].toFixed(3) * 100}% of place names have suffix \'${this.props.suffix[0]}\' or variations: ${hits.map((y)=> y.label).filter(function(value, index, self) {return self.indexOf(value) === index;}).join(", ")}`;
